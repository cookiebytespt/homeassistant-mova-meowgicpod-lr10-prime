...
| 🏛️ | **Propose a `litter_box` HA domain** — a dedicated entity platform + native card (draft in [`docs/`](docs/PROPOSAL-litter-box-entity-platform.md)) to replace the temporary `vacuum` mapping | 📝 Drafted |
